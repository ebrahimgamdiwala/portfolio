...
function Card() {
  ...
  return (
    ...
    >
      <div
        data-lenis-prevent
        className="max-h-[88dvh] overflow-y-auto rounded-2xl border border-white/12 bg-black/72 p-4 backdrop-blur-xl sm:p-6 transition-[backdrop-filter,background-color,opacity] duration-500 ease-out"
        style={{
